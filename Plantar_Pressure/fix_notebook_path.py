...
# New processing code (uses absolute path to avoid loading errors)
new_code = """import cv2
import numpy as np
...
# 이미지 절대 경로 생성 (웹캠으로 촬영한 raw RGB 이미지, LUT 없음)
...
# Find the first code cell containing 'import cv2' and replace its source
...
print('✅ notebook code cell updated with absolute path handling and Jet colormap processing.')
